package xl.qinhu.com.mytest.focus;
...
public abstract class AbsFocusBorder extends View implements FocusBorder, ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    protected void runBorderAnimation(View focusView, Options options) {
        Log.e("a", "runBorderAnimation: 到了这里");
        if (null == focusView) {
            Log.e("a", "runBorderAnimation: 到了这里1");
            return;
        }


        if (null != mAnimatorSet) {
            Log.e("a", "runBorderAnimation: 到了这里2");
            mAnimatorSet.cancel();
        }
        ...
        mAnimatorSet.start();
        Log.e("a", "runBorderAnimation: 到了这里4");
    }
    ...
    protected void createBorderAnimation(View focusView, Options options) {
        ...
        Log.e("a", "runBorderAnimation: 到了这里3");
    }    @Override
    ...
    abstract List<Animator> getSequentiallyAnimators(float newX, float newY, int newWidth, int newHeight, Options options);    @Override
